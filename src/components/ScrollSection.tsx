    ...
    <div className="relative overflow-hidden">
      <section className="stick top-0 slice-bg lg:py-40 py-20">
        <MaxWidthWrapper className="flex items-center justify-center">
          <div className="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 gap-20 relative ">
            <div className="content flex items-center justify-center ">
              <h1
                data-aos="fade-up"
                className=" sub-font text-white lg:text-4xl md:text-3xl text-2xl font-bold ">
            ...
            <div
              data-aos="fade-left"
              className="img lg:w-[750px] md:w-[600px] w-[400px]">
      ...
      <section className="stick top-0 bg-gradient lg:py-40 py-20">
        <MaxWidthWrapper className="flex items-center justify-center">
          <div className="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 gap-20">
            <div
              data-aos="fade-right"
              className="img lg:w-[750px] md:w-[600px] w-[400px] lg:ml-[-9rem] ml-[-5rem]">
              <Image src={img2} alt="img" className="rounded-tr-[4rem]" />
            </div>
            <div className="content flex items-center justify-center ">
              <h1
                data-aos="fade-up"
                className="sub-font text-[--primary] lg:text-4xl md:text-3xl text-2xl font-bold">
      ...
      <section className="stick top-0 bg-gradient lg:py-40 py-20">
        <MaxWidthWrapper className="flex items-center justify-center">
          <div className="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1  gap-20">
            <div
              data-aos="fade-right"
              className="img lg:w-[750px] md:w-[600px] w-[400px] lg:ml-[-13rem] ml-[-5rem]">
