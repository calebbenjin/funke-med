...
const Hero = () => {
  return (
    <section className="lg:h-[90vh] pb-20 h-full bg-white flex items-center justify-center relative">
      <div className="box bg-zinc-900 lg:h-60 lg:w-60 h-40 w-40 rounded-full absolute lg:left-[-10rem] left-[-7rem] bottom-[-3rem] "></div>
      <MaxWidthWrapper>
        <div className="flex items-center lg:flex-row md:flex-col flex-col pt-10 sm:gap-20 gap-10">
          <div className=" text-left flex flex-col">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-900 lg:text-5xl md:text-4xl ">
              Empowering Seamless Clinical Documentation
            </h1>
            <p className="sm:mt-8 mt-4 sm:text-lg text-md mr-auto max-w-prose text-muted-foreground">
